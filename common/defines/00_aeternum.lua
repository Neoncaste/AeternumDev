...
NDefines.NMilitary.SIEGE_DISEASE_IMPACT = 0.07 --Increased from 0.05
...
NDefines.NAI.OVER_FORCELIMIT_AVOIDANCE_FACTOR = 20 --Increased from 10
...
NDefines.NAI.ACCEPTABLE_BALANCE_DEFAULT = 1.6 --Decreased from 1.7
